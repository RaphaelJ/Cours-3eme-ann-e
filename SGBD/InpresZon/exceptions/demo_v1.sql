begin
   ...
   dbms_output.put_line ('Ajout correctement effectué');
exception
	when errnums_pkg.validation_ex then
       dbms_output.put_line
                     ('::: erreur de validation des données du client ::::');
       dbms_output.put_line ('::: ' || sqlerrm || ' ::::');
    when errnums_pkg.insertion_ex then
       dbms_output.put_line
              ('::: erreur lors de l''insertion des données du client ::::');
       dbms_output.put_line ('::: ' || sqlerrm || ' ::::');
	when others then
